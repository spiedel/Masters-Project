...
def getCoordsInt(number, lenNarrow, lenWide, xCen, yCen, angle):
	#get rotated points along each axis
...
def getCoordsFromEllipse(xBins, yBins, pArray, wilco1="qq3_i33i", wilco2="qq1_i33i"):
	#generate fitting points for the contours and output into a textfile
	#plots the fitted contour
	...
	#get points on contour for both ellipses
